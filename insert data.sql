...
DROP TABLE sales_person CASCADE;
ALTER TABLE  sales_person DROP COLUMN company; 
TRUNCATE TABLE sales_person;
SELECT setval('sales_person_id_seq', 3, false);
SELECT setval('sales_person_id_seq', 1, false);
...
DROP TABLE sales_order CASCADE;
